...
return {
  ...
  -- override nvim-cmp and add cmp-emoji
  {
    ...
    opts = function(_, opts)
      ...
      opts.window = cmp.config.sources(vim.list_extend(opts.window, { { completion = cmp.config.window.bordered() } }))
    end,
  },
      ...
      defaults = {
        ...
        mappings = {
          i = {
            ...
            ["<C-a>"] = function()
              return require("telescope.actions").send_to_qflist + require("telescope.actions").open_qflist()
            end,
          },
          n = {
            ["<C-j>"] = function()

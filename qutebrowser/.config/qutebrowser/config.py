...
config.bind('<Ctrl+Shift+m>', 'enter-mode insert ;; insert-text Karadžičova 16, 821 08 Ružinov')
...
config.bind('<Ctrl+Shift+m>', 'insert-text Karadžičova 16, 821 08 Ružinov', mode='insert')

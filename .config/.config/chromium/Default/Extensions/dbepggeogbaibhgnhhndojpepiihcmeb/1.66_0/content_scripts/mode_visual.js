...
(function() {
  ...
  Movement = (function() {
    ...
    Movement.prototype.reverseSelection = function() {
      var direction, element, j, length, original, range, ref, results, which;
      ...
      if (element && DomUtils.isEditable(element) && !element.isContentEditable) {
        ...
        results = [];
        for (j = 0, ref = length; 0 <= ref ? j < ref : j > ref; 0 <= ref ? j++ : j--) {
    ...
    Movement.prototype.getDirection = function() {
      var change, direction, j, len, ref;
  ...
  VisualMode = (function(superClass) {
    ...
    VisualMode.prototype.commandHandler = function(arg) {
      var command, count, j, ref, ref1;
      (ref = arg.command, command = ref.command), count = arg.count;
      switch (typeof command) {
        case "string":
          for (j = 0, ref1 = count; j < ref1; j += 1) {
    ...
    VisualMode.prototype.find = function(count, backwards) {
      var initialRange, j, nextQuery, ref;
  ...
  VisualLineMode = (function(superClass) {
    ...
    VisualLineMode.prototype.commandHandler = function(arg) {
      var command, count, direction, granularity, i, j, ref, ref1, ref2;
      (ref = arg.command, command = ref.command), count = arg.count;
      switch (typeof command) {
        case "string":
          for (i = j = 0, ref1 = count; j < ref1; i = j += 1) {
            this.movement.runMovement(command);
            if (this.selection.isCollapsed) {
              this.extendSelection();
              ref2 = command.split(' '), direction = ref2[0], granularity = ref2[1];
    ...
    VisualLineMode.prototype.extendSelection = function() {
      var direction, initialDirection, j, len, ref, results;

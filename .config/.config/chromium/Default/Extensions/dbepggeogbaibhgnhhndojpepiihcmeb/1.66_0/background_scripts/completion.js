...
(function() {
  ...
  Suggestion = (function() {
    ...
    Suggestion.prototype.generateHtml = function(request) {
      var favIcon, insertTextClass, insertTextIndicator, relevancyHtml;
      if (this.html) {
        return this.html;
      }
      ...
      favIcon = this.type === "tab" && !Utils.isFirefox() ? "<img class=\"vimiumReset vomnibarIcon\" src=\"chrome://favicon/size/16@1x/" + (BgUtils.escapeAttribute(this.url)) + "\" />" : "";
  ...
  TabCompleter = (function() {
    ...
    TabCompleter.prototype.filter = function(arg, onComplete) {
      var name, queryTerms;
      name = arg.name, queryTerms = arg.queryTerms;
      ...
      return chrome.tabs.query({}, (function(_this) {
        return function(tabs) {
          ...
          suggestions = results.map(function(tab) {
            ...
            suggestion.relevancy = _this.computeRelevancy(suggestion);
            return suggestion;
          }).sort(function(a, b) {

...
vim.api.nvim_create_autocmd('FileType', {
  ...
  desc = 'Close quickfix list with q',
})
...
vim.keymap.set('n', '<leader>clr', '<CMD>LspRestart<CR>', { desc = '[C]ode [L]sp [R]estart' })
  ...
  },
  {
    ...
    dependencies = {
      ...
      { 'williamboman/mason.nvim', opts = {}, keys = {
        { '<leader>cm', '<CMD>Mason<CR>', desc = 'Mason [C]ode [M]mason' },
      } },
